...
confidence and shorter turnarounds for lifting prod packages.
...
(note that no matter how awful NPM is, at least it's namespaced).  Well,
and Firefly is first-and-a-half party.
